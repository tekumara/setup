# Generated by Powerlevel10k configuration wizard on 2022-10-29 at 22:47 AEDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # gcloud                # disabled: synchronous prefetch can block the prompt
  ...
  # -- jj: start see https://zerowidth.com/2025/async-zsh-jujutsu-prompt-with-p10k/
